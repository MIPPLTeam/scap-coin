...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop SafeCapital server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "SafeCapital server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* SafeCapital features */
        {"safecapital", "masternode", &masternode, true, true, false},
        {"safecapital", "listmasternodes", &listmasternodes, true, true, false},
        {"safecapital", "getmasternodecount", &getmasternodecount, true, true, false},
        {"safecapital", "masternodeconnect", &masternodeconnect, true, true, false},
        {"safecapital", "masternodecurrent", &masternodecurrent, true, true, false},
        {"safecapital", "masternodedebug", &masternodedebug, true, true, false},
        {"safecapital", "startmasternode", &startmasternode, true, true, false},
        {"safecapital", "createmasternodekey", &createmasternodekey, true, true, false},
        {"safecapital", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"safecapital", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"safecapital", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"safecapital", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"safecapital", "getmasternodescores", &getmasternodescores, true, true, false},
        {"safecapital", "mnbudget", &mnbudget, true, true, false},
        {"safecapital", "preparebudget", &preparebudget, true, true, false},
        {"safecapital", "submitbudget", &submitbudget, true, true, false},
        {"safecapital", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"safecapital", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"safecapital", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"safecapital", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"safecapital", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"safecapital", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"safecapital", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"safecapital", "checkbudgets", &checkbudgets, true, true, false},
        {"safecapital", "mnsync", &mnsync, true, true, false},
        {"safecapital", "spork", &spork, true, true, false},
        {"safecapital", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"safecapital", "privatesend", &privatesend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use safecapitald, or the -server option to safecapital-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> safecapital-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:33998/\n";
}
