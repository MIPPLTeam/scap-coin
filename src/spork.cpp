...
bool IsSporkActive(int nSporkID)
{
    ...
    if (mapSporksActive.count(nSporkID)) {
        ...
        if (nSporkID == SPORK_17_STAKE_MINIMUM_AGE) r = SPORK_17_STAKE_MINIMUM_AGE_DEFAULT;
        if (nSporkID == SPORK_18_STAKE_MINIMUM_SIZE) r = SPORK_18_STAKE_MINIMUM_SIZE_DEFAULT;
...
int CSporkManager::GetSporkIDByName(std::string strName)
{
    ...
    if (strName == "SPORK_17_STAKE_MINIMUM_AGE") return SPORK_17_STAKE_MINIMUM_AGE;
    if (strName == "SPORK_18_STAKE_MINIMUM_SIZE") return SPORK_18_STAKE_MINIMUM_SIZE;
...
std::string CSporkManager::GetSporkNameByID(int id)
{
    ...
    if (id == SPORK_17_STAKE_MINIMUM_AGE) return "SPORK_17_STAKE_MINIMUM_AGE";
    if (id == SPORK_18_STAKE_MINIMUM_SIZE) return "SPORK_18_STAKE_MINIMUM_SIZE";
